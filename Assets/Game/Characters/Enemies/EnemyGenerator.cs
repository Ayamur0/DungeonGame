                ...
                for (float f= 1.0f; f <= amountEnemy; f++)
                {
                    switch (enemies)
                    {
                        case EnemyType.SkeletonBasic:
                            ...
                            skeleton_object.GetComponent<EnemyController>().Awake(Random.Range(0.3f, 0.5f) * 10, 2f, 8f, 2f, 10f, 2f);
                        ...
                        case EnemyType.Archer:
                            ...
                            archer.GetComponent<EnemyController>().Awake(Random.Range(0.2f, 0.4f) * 10, 3f, 11f, 8f, 10f, 6f);
                ...
                for (float f = 1.0f; f <= amountEnemy; f++)
                {
                    switch (enemies)
                    {
                        case EnemyType.SkeletonBasic:
                            ...
                            skeleton_basic_object.GetComponent<EnemyController>().Awake(Random.Range(0.3f, 0.5f) * healthFactor * 10, 2f * damagePointsFactor, 8f, 2f, 10f, 2f * shootIntervalFactor);
                            returnList.Add(skeleton_basic_object);
                            break;
                        case EnemyType.Archer:
                            GameObject archer = Instantiate(archer_prefab, new Vector3(0 + Random.Range(0.0f, 0.8f) * 10, 0, 0 * Random.Range(0.0f, 0.8f)), Quaternion.identity);
                            archer.GetComponent<EnemyController>().Awake(Random.Range(0.2f, 0.4f) * healthFactor * 10, 3f * damagePointsFactor, 11f, 8f, 10f, 6f * shootIntervalFactor);
                            returnList.Add(archer);
                            break;
                        case EnemyType.BigSkeleton:
                            ...
                            bigSkeleton_object.GetComponent<EnemyController>().Awake(Random.Range(0.6f, 0.18f) * 10, 6f, 6f, 2f, 4f, 6f);
                        ...
                        case EnemyType.Magician:
                            ...
                            witch_object.GetComponent<EnemyController>().Awake(Random.Range(0.2f, 0.4f) * healthFactor * 10, 3f * damagePointsFactor, 11f, 8f, 10f, 6f * shootIntervalFactor);
                        ...
                        case EnemyType.Wiking:
                            ...
                            wiking_object.GetComponent<EnemyController>().Awake(Random.Range(0.3f, 0.5f) * healthFactor * 10, 2f * damagePointsFactor, 8f, 2f, 10f, 2f * shootIntervalFactor);
